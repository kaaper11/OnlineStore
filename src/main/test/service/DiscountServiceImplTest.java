...
class DiscountServiceImplTest {
    ...
    void shouldApplyPercentDiscount() {
        ...
        assertEquals(BigDecimal.valueOf(90.0).setScale(1), result.setScale(1));
    }
    ...
    void shouldReturnDiscountForProduct() {
        ...
        DiscountDto result = service.getDiscountForProduct(100L);
    ...
    void shouldThrowWhenDiscountNotFound() {
        when(discountRepository.getByProductId(100L)).thenReturn(Optional.empty());

        assertThrows(DiscountNotFoundException.class, () -> service.getDiscountForProduct(100L));
    }
